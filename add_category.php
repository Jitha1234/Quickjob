...
?>
  ...
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item"><a href="#"> Add Category</a></li>
		  ...
		  <form action="" method="post" style="margin:3% padding:3%;" name="compnany-form" id="company-form">
		  <div id="msg"></div>
		    <div class="form-group">
			 <label for="Company name">Category Name</label>
			 <input type="text" name="category" id="company" class="form-control" placeholder="Enter Company Name">
			</div>
			<div class="form-group">
